...
urlpatterns = [
    ...
    url(r'^all_advice/$', views.all_advice, name='all_advice'),
    url(r'^repair_orders/(?P<report_id>\w+)/$', views.repair_orders, name='repair_orders'),
    ...
    url(r'^advice_detail/(?P<advice_id>\w+)/$', views.advice_detail, name='advice_detail'),
    ...
    url(r'^repair_orders/(?P<report_id>\w+)/$', views.repair_orders, name='repair_orders'),
    url(r'^publish_news/$', views.publish_news, name='publish_news'),
]
